...
\include{content/ResearchQuestions}
...
\begin{appendix}
    \include{content/appendix_tabTotext}
    \include{content/appendix_config}
    \include{content/appendix1}
    \include{content/appendix_begreat}
    \include{content/appendix_llama}
    \include{content/appendix_textTotab}
\end{appendix}
